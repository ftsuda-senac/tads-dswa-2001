...
public class ExemploSessaoController3 {
	...
	public ModelAndView adicionarItem(
		...
		List<ItemSelecionado> itensSelecionados = (List<ItemSelecionado>) sessao.getAttribute("itensSelecionados3");
	...
	@GetMapping("/limpar")
	public ModelAndView limparSessao(HttpServletRequest request, RedirectAttributes redirAttr) {
	...
	public String getTitulo() {
		return "Exemplo Sessao 3 - Uso do HttpServletRequest para recuperar HttpSession";
	}
